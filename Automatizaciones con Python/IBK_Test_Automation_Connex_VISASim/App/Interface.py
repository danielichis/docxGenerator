...
class App:
    def __init__(self, root):
        ...
        # ft = tkFont.Font(family='Times',size=10)
        # GCheckBox_410["font"] = ft
        # GCheckBox_410["fg"] = "#333333"
        # GCheckBox_410["justify"] = "center"
        # GCheckBox_410["text"] = "Fecha de hoy"
        # GCheckBox_410.place(x=35,y=210,width=100,height=25)
        # GCheckBox_410["offvalue"] = "0"
        # GCheckBox_410["onvalue"] = "1"
        # GCheckBox_410["command"] = self.GCheckBox_410_command
    ...
    # def GCheckBox_667_command(self):
    ...
    def GButton_925_command(self):
        ...
        if (self.selected.get() is None or self.selected.get() == "") and (
            ...
            if len(self.selected.get()) == 16 and len(self.expected_value.get()) == 2:
                ...
                with open(env("JSON_DIRECTORY") + "values.json", "w") as outfile:
